...
def main():
	...
	for string in file_list:
		org = unhexlify(string)	
		do_xor(org)
		#print("\n........Calculating Score for " + string +" :\n")
		for i in range(0,128):
			dict_list[i]["score"] = score(dict_list[i]["xored_string"])
			dict_list[i]["hexstring"] = string
		#print("\n........Printing Score.........\n")
		final_list.append(sorted(dict_list, key = lambda i: i['score'], reverse = True)[0])
		dict_list.clear()
		#print("\n")
	print(sorted(final_list, key = lambda i: i['score'], reverse = True)[0])
